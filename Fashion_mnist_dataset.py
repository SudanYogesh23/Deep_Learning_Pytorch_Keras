...
#data exploration
train_pt= datasets.FashionMNIST(root='Z:/Sudan Academic/Thesis/Dataset', train=True, download=True, transform=transform)
trainldr = torch.utils.data.DataLoader(train_pt, batch_size=64, shuffle=True)
test_pt= datasets.FashionMNIST(root='Z:/Sudan Academic/Thesis/Dataset', train=False,download=True,transform=transform)
